...
const EventPageSkeleton: React.FC = () => {
  return (
    <div className="flex overflow-hidden flex-col pb-20 bg-white dark:bg-[#0b0b0b] rounded-3xl min-h-screen">
        ...
        <div className="flex flex-row gap-8 w-full mt-10 max-md:flex-col max-md:gap-6">
          <div className="flex flex-col w-[62%] max-md:w-full gap-4">
            ...
            <div className="flex flex-row gap-4 mt-6 max-md:flex-col">
              <div className="flex-1 p-6 rounded-xl border bg-white dark:bg-[#1F1F1F] dark:border-[#2A2A2A]">
          ...
          <div className="flex flex-col w-[38%] max-md:w-full gap-4">
            <div className="p-5 rounded-xl border bg-white dark:bg-[#1F1F1F] dark:border-[#2A2A2A]">
