...
const AccountSettingsSkeleton: React.FC = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0b0b0b]">
      <Header />
      <div className="flex">
        <div className="w-[280px] h-[100vh] bg-gray-50 dark:bg-[#121212] border-r border-gray-100 dark:border-[#1F1F1F] max-md:w-[250px] max-sm:hidden">
        ...
        <div className="flex-1 flex justify-center items-start py-12 px-8 bg-[#F8F7FA] dark:bg-[#0b0b0b]">
          <div className="w-full max-w-[700px] bg-white dark:bg-[#1F1F1F] rounded-3xl shadow-xl p-10 border border-gray-100 dark:border-[#2A2A2A]">
            <Skeleton className="h-8 w-64 mb-2" />
            <hr className="my-6 border-gray-200 dark:border-[#2A2A2A]" />
            <div className="mb-8">
