  ...
  return (
    <div
      ...
      style={{
        ...
        '--cp-glass': cardBackground.toLowerCase() === '#1b1d1f' ? 'rgba(27,29,31,.64)' : 'rgba(255,255,255,.72)',
...
.cp-event-card{display:flex;width:100%;min-width:0;max-width:100%;box-sizing:border-box;overflow:hidden;flex-direction:column;align-items:flex-start;gap:10px;padding:12px 12px 12px 16px;border:1px solid var(--cp-border);border-radius:13px;background:var(--cp-card);box-shadow:0 1px 3px rgba(0,0,0,.12);cursor:pointer;transition:border-color .16s ease,background-color .16s ease}.cp-event-card:hover{border-color:rgba(255,255,255,.28)}.cp-event-card-main{display:flex;width:100%;min-width:0;align-items:flex-start;justify-content:space-between;gap:16px}.cp-event-card-copy{min-width:0;flex:1 1 0;overflow:hidden}.cp-event-card time,.cp-event-row time,.cp-external-card time{color:var(--cp-secondary);font-size:15px;font-weight:550;font-style:normal}.cp-event-card time em,.cp-event-row time em,.cp-external-card time em{color:#efc34f;font-style:normal;font-weight:600}.cp-event-card h3{display:flex;align-items:center;gap:7px;margin:7px 0 8px;font-size:20px;line-height:1.12;font-weight:600}.cp-event-card h3 svg{padding:4px;border-radius:50%;box-sizing:content-box;color:#ff6ba8;background:rgba(213,23,109,.18)}.cp-event-card p,.cp-event-row p{display:flex;min-width:0;align-items:center;gap:6px;margin:5px 0;color:var(--cp-secondary);font-size:14px;font-weight:550}.cp-event-card p span,.cp-event-row p span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.cp-event-card p img,.cp-event-row p img{width:18px;height:18px;flex:0 0 18px;border-radius:50%;object-fit:cover}.cp-event-card button{display:inline-flex;align-items:center;gap:7px;margin-top:12px;padding:7px 10px;border:0;border-radius:8px;color:rgba(255,255,255,.70);background:rgba(255,255,255,.10);font-size:12px;font-weight:650;cursor:pointer;transition:background .16s,color .16s}.cp-event-card button:hover{color:#fff;background:rgba(255,255,255,.17)}.cp-event-cover{display:grid;width:120px;height:120px;flex:0 0 120px;overflow:hidden;place-items:center;border-radius:10px;color:var(--cp-secondary);background:rgba(255,255,255,.04)}.cp-event-cover img{width:100%;height:100%;object-fit:cover}.cp-event-price{display:inline-flex;align-items:center;padding:4px 7px;border-radius:5px;color:#58d66b;background:rgba(34,132,50,.28);font-size:11px;line-height:1;font-weight:700}
