...
const dateLabel = (value: string) => {
  ...
  const dayMonth = date.toDateString() === today.toDateString()
    ? 'Hoje'
    : new Intl.DateTimeFormat('pt-BR', { day: 'numeric', month: 'short' }).format(date);
...
const StickyEventDate = ({ value }: { value: string }) => {
  ...
  return <header ref={ref} className={`cp-event-date${stuck ? ' is-stuck' : ''}`}><i /><strong>{label.dayMonth}</strong><span>{label.weekday}</span></header>;
};
...
.cp-event-card{display:flex;width:100%;min-width:0;max-width:100%;min-height:190px;box-sizing:border-box;overflow:hidden;align-items:center;justify-content:space-between;gap:22px;padding:18px;border:1px solid var(--cp-border);border-radius:13px;background:var(--cp-card);cursor:pointer;transition:border-color .16s ease,background-color .16s ease}.cp-event-card:hover{border-color:rgba(255,255,255,.28)}.cp-event-card-copy{min-width:0;flex:1 1 0;overflow:hidden}.cp-event-card time,.cp-event-row time{color:var(--cp-secondary);font-size:15px;font-weight:650}.cp-event-card h3{display:flex;align-items:center;gap:7px;margin:8px 0 10px;font-size:20px;font-weight:700}.cp-event-card h3 svg{padding:4px;border-radius:50%;box-sizing:content-box;color:#ff6ba8;background:rgba(213,23,109,.18)}.cp-event-card p,.cp-event-row p{display:flex;min-width:0;align-items:center;gap:7px;margin:6px 0;color:var(--cp-secondary);font-size:14px;font-weight:550}.cp-event-card p span,.cp-event-row p span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.cp-event-card p img,.cp-event-row p img{width:18px;height:18px;flex:0 0 18px;border-radius:50%;object-fit:cover}.cp-event-card button{display:inline-flex;align-items:center;gap:7px;margin-top:16px;padding:8px 12px;border:0;border-radius:8px;color:rgba(255,255,255,.70);background:rgba(255,255,255,.10);font-size:13px;font-weight:650;cursor:pointer;transition:background .16s,color .16s}.cp-event-card button:hover{color:#fff;background:rgba(255,255,255,.17)}.cp-event-cover{display:grid;width:120px;height:120px;flex:0 0 120px;overflow:hidden;place-items:center;border-radius:10px;color:var(--cp-secondary);background:rgba(255,255,255,.04)}.cp-event-cover img{width:100%;height:100%;object-fit:cover}
...
@media(max-width:640px){.cp-event-group{margin-bottom:24px}.cp-events--cards .cp-event-group{padding-left:25px}.cp-events--cards .cp-event-group:before{left:5px;bottom:-25px}.cp-event-date{position:sticky;top:12px;z-index:20;width:max-content;max-width:calc(100% + 25px);min-height:31px;box-sizing:border-box;align-items:center;gap:6px;margin-bottom:12px;padding:4px 0;transition:margin .18s ease,padding .18s ease,background-color .18s ease,box-shadow .18s ease,backdrop-filter .18s ease}.cp-events--list .cp-event-date{padding-bottom:4px;border-bottom:0}.cp-events--cards .cp-event-date i{left:-25px;top:50%;width:8px;height:8px;transform:translateY(-50%)}.cp-event-date.is-stuck,.cp-events--list .cp-event-date.is-stuck{margin-left:-25px;padding:5px 13px 5px 30px;border:1px solid var(--cp-border);border-radius:999px;background:color-mix(in srgb,var(--cp-card) 82%,transparent);box-shadow:0 5px 18px rgba(0,0,0,.22);-webkit-backdrop-filter:blur(14px) saturate(145%);backdrop-filter:blur(14px) saturate(145%)}.cp-events--cards .cp-event-date.is-stuck i{left:10px}.cp-event-card{min-height:145px;gap:12px;padding:12px;border-radius:11px}.cp-event-card time,.cp-event-row time{font-size:13px}.cp-event-card h3,.cp-external-card h3{display:-webkit-box;overflow:hidden;margin:7px 0 8px;font-size:16px;line-height:1.2;-webkit-box-orient:vertical;-webkit-line-clamp:2}.cp-event-card p,.cp-event-row p{margin:5px 0;overflow:hidden;font-size:13px;white-space:nowrap}.cp-event-card p svg,.cp-event-row p svg{flex:0 0 auto;width:15px;height:15px}.cp-event-cover{width:88px;height:88px;flex-basis:88px;border-radius:8px}.cp-event-card button{margin-top:10px;padding:6px 9px;font-size:11px}.cp-event-row{grid-template-columns:54px minmax(0,1fr);gap:11px;min-height:100px;padding-top:14px;padding-bottom:14px}.cp-event-organizing{grid-column:2}.cp-event-date strong{font-size:15px}.cp-event-date span{font-size:13px}.cp-external-card{width:100%;max-width:100%;box-sizing:border-box;overflow:hidden;min-height:145px;padding:13px 14px}.cp-external-menu{right:-4px;width:205px}}
`;
