  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-[220px] h-[48px] border shadow-[0_4px_12.9px_0_rgba(0,0,0,0.05)] flex items-center bg-white px-4 py-0 rounded-[25px] border-solid border-[#E0E0E0] hover:border-[#2A2AD7] transition-colors"
      >
