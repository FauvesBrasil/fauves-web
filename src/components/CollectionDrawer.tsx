  ...
  return (
    <Drawer open={open} onOpenChange={(o)=>{ if(!o) onClose(); }}>
      <DrawerContent>
        ...
        {mode==='edit' && onDelete && (
          <div className="px-6 pb-4 -mt-2">
            <button onClick={() => setShowDeleteConfirm(true)} type="button" className="text-xs font-medium text-red-600 hover:text-red-700">Excluir coleção</button>
          </div>
        )}
      </DrawerContent>
      ...
      <WarpDialog
        ...
        description="Tem certeza que deseja excluir esta coleção?"
