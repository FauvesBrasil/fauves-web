...
const ResetPassword = () => {
    ...
    const handleSubmit = async () => {
        ...
        // Return to sign-in after the password has been changed.
        setTimeout(() => {
    ...
    return (
        <AppShell hideSearchOnMobile>
            <div className="min-h-[100dvh] w-full overflow-x-hidden flex items-center justify-center px-4 bg-background py-24 sm:py-12">
                <div className="w-full max-w-md">
                    <div className="bg-card dark:bg-[#0b0b0b] rounded-2xl shadow-brand-lg p-5 sm:p-8">
                        {/* Logo */}
                        ...
                        {success ? (
                            ...
                            <div className="flex flex-col items-center py-6">
                                ...
                                <button
                                    ...
                                    className="min-h-11 px-3 text-indigo-600 dark:text-indigo-400 font-semibold hover:underline"
                                >
                                    Voltar para entrar
                                </button>
                            </div>
                            ...
                            <form onSubmit={(e) => { e.preventDefault(); }} className="space-y-4">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="min-h-12 w-full border border-border dark:border-[#1F1F1F] bg-input dark:bg-[#242424] text-foreground dark:text-white placeholder:text-muted-foreground dark:placeholder:text-slate-500 rounded-lg px-3 py-3 pr-12"
                                        autoFocus
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                        className="absolute right-1 top-1/2 min-h-11 min-w-11 -translate-y-1/2 inline-flex items-center justify-center text-muted-foreground dark:text-slate-400 hover:text-foreground dark:hover:text-white"
