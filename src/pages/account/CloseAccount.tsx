  ...
  return (
    <div className="flex-1 flex justify-center items-start py-12 px-8 bg-[#F8F7FA]">
      <div className="w-full max-w-[700px] bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
        ...
        <p className="text-base text-[#091747] mb-6">Obrigado por utilizar a Fauves. Se houver algo que podemos fazer para você permanecer conosco, basta nos dizer.</p>
        <p className="text-base text-[#091747] mb-4">Disponha de alguns minutos para nos indicar o motivo pelo qual está saindo:</p>
        <form className="flex flex-col gap-6">
          ...
          <label className="text-base text-[#091747] mt-4 mb-2">Digite "ENCERRAR" e insira sua senha para confirmar que deseja encerrar sua conta</label>
