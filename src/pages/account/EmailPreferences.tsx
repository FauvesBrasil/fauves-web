...
const EmailPreferences: React.FC = () => {
  ...
  return (
    <>
  <h1 className="text-3xl max-sm:text-2xl font-bold text-[#091747] dark:text-white mb-6 max-sm:mb-4">Preferências de e-mail</h1>
      <hr className="my-6 max-sm:my-4 border-gray-200" />
      <form className="flex flex-col gap-10 max-sm:gap-6">
          {/* Participando de eventos */}
          <div>
            <h2 className="text-xl max-sm:text-lg font-bold text-[#091747] dark:text-white mb-2">Participando de eventos</h2>
            <p className="text-base max-sm:text-sm text-[#091747] dark:text-white mb-4 max-sm:mb-3">Notícias e atualizações sobre eventos criados por organizadores de eventos</p>
            <div className="mb-4 max-sm:mb-3">
              <h3 className="text-base max-sm:text-sm font-bold text-[#091747] dark:text-white mb-2">Receber E-mails</h3>
              <div className="flex flex-col gap-2 max-sm:gap-1.5 ml-2 max-sm:ml-0">
            ...
            <div className="mb-4 max-sm:mb-3">
              <h3 className="text-base max-sm:text-sm font-bold text-[#091747] dark:text-white mb-2">Notificações</h3>
              <div className="flex flex-col gap-2 max-sm:gap-1.5 ml-2 max-sm:ml-0">
          ...
          {/* Organizando eventos */}
          <div>
            <h2 className="text-xl max-sm:text-lg font-bold text-[#091747] dark:text-white mb-2">Organizando eventos</h2>
            <p className="text-base max-sm:text-sm text-[#091747] dark:text-white mb-4 max-sm:mb-3">Atualizações e dicas úteis para organizar eventos na Fauves</p>
            <div className="mb-4 max-sm:mb-3">
              <h3 className="text-base max-sm:text-sm font-bold text-[#091747] dark:text-white mb-2">Receber E-mails</h3>
              <div className="flex flex-col gap-2 max-sm:gap-1.5 ml-2 max-sm:ml-0">
          ...
          <div className="flex justify-start max-sm:justify-stretch mt-6 max-sm:mt-4">
            <button type="submit" className="bg-[#2A2AD7] text-white font-bold px-8 py-3 max-sm:w-full rounded-lg text-lg max-sm:text-base shadow hover:bg-[#091747] transition-colors">Salvar preferências</button>
          </div>
        </form>
    </>
  );
