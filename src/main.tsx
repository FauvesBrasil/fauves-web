import "./lib/apiBase"; // Apply global fetch patch immediately
		...
		requestAnimationFrame(() => requestAnimationFrame(() => {
			...
			const finalize = () => {
				...
				if (complete) {
					...
					}, 1000); // reduced from 1500ms for faster transition
				} else {
			...
			const READY_DELAY = 100; // ms (reduced from 250ms for faster transition)
