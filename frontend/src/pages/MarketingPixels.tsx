      ...
      <div style={{ marginLeft: totalLeft, transition: 'margin-left 200ms' }} className="flex flex-col pl-8 pr-8 min-h-screen relative">
        <div className="mt-24 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {pixelTypes.map(p => (
              <div key={p.key} onClick={() => openModalFor(p.key)} className="cursor-pointer border rounded-xl p-5 flex items-start gap-4 shadow-sm bg-white dark:bg-[#242424] dark:border-[#1F1F1F] hover:shadow-md transition">
                ...
                <div className="flex-1">
                  <div className="font-medium text-sm dark:text-white">{p.title}</div>
                  <div className="text-xs text-gray-500 mt-1 dark:text-slate-300">+ {p.subtitle}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white border border-zinc-200 rounded-xl dark:bg-[#242424] dark:border-[#1F1F1F]">
            <div className="px-6 py-3 border-b text-sm text-zinc-600 grid grid-cols-3 dark:text-slate-300 dark:border-[#1F1F1F]">
              <div>Tipo de pixel</div>
              <div>Gatilho</div>
              <div>Eventos</div>
            </div>
            <div className="p-8 text-center text-sm text-zinc-500 dark:text-slate-300">Nenhum pixel de rastreamento configurado</div>
          </div>

          <div className="mt-6">
            <a className="inline-flex items-center gap-2 rounded-md bg-zinc-50 px-4 py-2 text-sm text-zinc-700 border dark:bg-[#1F1F1F] dark:text-slate-300 dark:border-[#1F1F1F]" href="#" onClick={(e) => { e.preventDefault(); window.open('https://help.example.com', '_blank'); }}>
